...
================
*/
// *<symbol> - skip all until <symbol>: *n - skip all chars before "n"
// +<symbol> - skip all <symbol>s: +n - skip bunch of "n" 
// ~<symbol> - threat as <symbol>: ~* is "*" symbol, ~~ is "~" symbol

int idStr::Cmpf( const char *s, const char *f ) {
	int c1, c2, d;
...
================
*/
int idStr::Icmpf( const char *s, const char *f ) {
	int c1, c2, d;
