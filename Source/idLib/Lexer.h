...
typedef enum {
	...
	LEXFL_NOOXDIGITS					= BIT(14)	// disable 0x numbers
} lexerFlags_t;
...
public:
	...
	void			SetPunctuations( const punctuation_t *p );
					// make punctuations compatible
	void			CopyPunctuations( const idLexer *lex );
...
private:
	void			CreatePFlagTable( );	// punctuation flags update
