...
public:
	...
	virtual int					KeyState( int key ) = 0;
								...
								// Reverted by c4tnt
								// Returns key bound to the command
	const char *				KeysFromBinding( const char *bind );
...
ID_INLINE const char *	idCommon::KeysFromBinding( const char *_bind ) {
	
	DWORD _return;
	const DWORD _addr = 0x447DC0;
