...
public:
							// Reverted by c4tnt
	const idDecl*			FindDeclWithoutParsing( declType_t type, const char *name, bool makeDefault = true );
#endif
};
...
ID_INLINE const idDecl* idDeclManager::FindDeclWithoutParsing( declType_t type, const char *name, bool makeDefault ) {
	
	int _type = type;
	const char* _name = name;
	int _mkDefault = makeDefault;
	DWORD _return;
	const DWORD _addr = 0x4301A0;
