...
const int BUTTON_ALTATTACK		= BIT(5); //c4tnt: Alt attack (BUTTON_5)
...
const int IMPULSE_21			= 21;			// show INV (c4tnt)
const int IMPULSE_22			= 22;			// spectate
const int IMPULSE_23			= 23;			// INV USE (c4tnt - use current item from the inventory, for BAR inventory only)
const int IMPULSE_24			= 24;			// INV FWD (c4tnt - BAR inv next item )
const int IMPULSE_25			= 25;			// INV BCK (c4tnt - BAR inv prev item )
const int IMPULSE_26			= 26;			// DROP	   (c4tnt - Drops weapon or selected inventory item )
const int IMPULSE_27			= 27;			// <unused>
const int IMPULSE_28			= 28;			// vote yes
const int IMPULSE_29			= 29;			// vote no
const int IMPULSE_30			= 30;			// <unused>
const int IMPULSE_31			= 31;			// <unused>
const int IMPULSE_32			= 32;			// <unused>
const int IMPULSE_33			= 33;			// <unused>
const int IMPULSE_34			= 34;			// <unused>
const int IMPULSE_35			= 35;			// <unused>
const int IMPULSE_36			= 36;			// <unused>
const int IMPULSE_37			= 37;			// <unused>
const int IMPULSE_38			= 38;			// <unused>
const int IMPULSE_39			= 39;			// <unused>
const int IMPULSE_40			= 40;			// use (c4tnt: Now this impulse allows to use any object)
...
#if (API_VERS >= 4) // Only wich APIv 7
