...
================
*/
void idIK::Save( idSave_I *savefile ) const {
...
================
*/
void idIK::Restore( idRestore_I *savefile ) {
	idStr anim;
...
================
*/
void idIK_Walk::Save( idSave_I *savefile ) const {
	int i;
...
================
*/
void idIK_Walk::Restore( idRestore_I *savefile ) {
	int i;
...
================
*/
void idIK_Reach::Save( idSave_I *savefile ) const {
	int i;
	idIK::Save( savefile );
...
================
*/
void idIK_Reach::Restore( idRestore_I *savefile ) {
	int i;
	idIK::Restore( savefile );
