...
===============================================================================
  ...
  Base class for cinematic cameras
...
================
*/
void idCameraView::Save( idSave_I *savefile ) const {
...
================
*/
void idCameraView::Restore( idRestore_I *savefile ) {
...
================
*/
void idCameraView::Event_SetAttachments( void ) {
...
void idCameraView::Spawn( void ) {
	...
	PostEventMS( &EV_Camera_SetAttachments, NULL, 0 );
...
================
*/
void idCameraAnim::Save( idSave_I *savefile ) const {
...
================
*/
void idCameraAnim::Restore( idRestore_I *savefile ) {
...
================
*/
void idCameraAnim::Event_SetCallback( idEventReturn *returnContext ) {
