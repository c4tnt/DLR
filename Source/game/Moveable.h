...
protected:
	...
	idStr					monsterDamage;			// ROE
	idEntity				*attacker;				// attacker override
	...
	void					Event_IsAtRest( idEventReturn *returnContext ); //return d
...
private:
	...
	void					Event_TriggerTargets( void );
	void					Event_Stability( float unstable );
	void					Event_Burn( );
};
