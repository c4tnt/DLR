...
static const int WPM_A = 1;
static const int WPM_B = 2;
static const int WPM_C = WPM_A | WPM_B;

typedef int ammo_t;
static const int AMMO_NUMTYPES = 32;
...
public:
	...
	void					OwnerDied( void );
	void					BeginAttack( const int mode );
	void					EndAttack( void );
	...
	static ammo_t			GetAmmoNumForNameSafe( const char *ammoname );
...
private:
	...
	// for special weapons such as PDA and fists
	bool					notaweapon;
	...
	void					Event_GetOwner( idEventReturn *returnContext ); //return e
	void					Event_WeaponState( const char *statename, int blendFrames );
	void					Event_SetWeaponStatus( float newStatus ); //bad event?
	...
	void					Event_AmmoInClip( idEventReturn *returnContext ); //return f
	void					Event_AmmoAvailable( idEventReturn *returnContext ); //return f
	void					Event_TotalAmmoCount( idEventReturn *returnContext ); //return f
	void					Event_ClipSize( idEventReturn *returnContext ); //return f
	void					Event_PlayAnim( idEventReturn *returnContext, int channel, const char *animname ); //return d
	void					Event_PlayCycle( idEventReturn *returnContext, int channel, const char *animname ); //return d
	...
	void					Event_GetLightParm( idEventReturn *returnContext, int parmnum ); //return f
	...
	void					Event_CreateProjectile( idEventReturn *returnContext ); //return e
	void					Event_EjectBrass( void );
	void					Event_Melee( idEventReturn *returnContext ); //return d
	void					Event_GetWorldModel( idEventReturn *returnContext ); //return e
	void					Event_AllowDrop( int allow ); 
	void					Event_AutoReload( idEventReturn *returnContext ); //return f
	void					Event_NetReload( void );
	void					Event_IsInvisible( idEventReturn *returnContext ); //return f
