...
================
*/
void idLiquid::Save( idSave_I *savefile ) const {
...
================
*/
void idLiquid::Restore( idRestore_I *savefile ) {
...
/*
================
idLiquid::getSubmergedMtr
================
*/

const char* idLiquid::getSubmergedMtr() const {
	if ( underwaterMtr.Length() == 0)
		return NULL;

	return underwaterMtr.c_str();
}
...
void idLiquid::Spawn() {
	...
	spawnArgs.GetString("submerged_texture","",underwaterMtr);
...
void idLiquid::SetupModel( const idRenderModel *renderModel ) {
...
================
*/
impactEffect_t idLiquid::Collide( const trace_t &collision, const idVec3 &velocity ) {
