...
public:
	...
	void				SetupViewObjects( void );
	void				ClearViewObjects( void );
...
private:
	...
	void				ScreenFade();
	//c4tnt : ff DLR functions
	void				ffDepth( const renderView_t *view );
	...
	const idMaterial *	depthgMaterial;		// c4tnt: depth's group data (fixed dlr functionality)
	...
	const idMaterial *	submergedMaterial;	// c4tnt: underwater overlay

	qhandle_t			globalFog_h;			// global fog light
	renderLight_t		globalFog_t;
