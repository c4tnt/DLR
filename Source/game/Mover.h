...
private:
	...
	void					Event_SetCallback( idEventReturn *returnContext );	
	...
	void					Event_IsMoving( idEventReturn *returnContext ); //return d
	void					Event_IsRotating( idEventReturn *returnContext ); //return d
};
...
protected:
	...
	void					Event_SetCallback( idEventReturn *returnContext ); //return d? fuckin'shit!!!!
...
private:
	...
	void					Event_IsOpen( idEventReturn *returnContext ); //return f
