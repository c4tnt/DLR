...
================
*/
void idPhysics_Monster_SavePState( idSave_I *savefile, const monsterPState_t &state ) {
...
================
*/
void idPhysics_Monster_RestorePState( idRestore_I *savefile, monsterPState_t &state ) {
...
================
*/
void idPhysics_Monster::Save( idSave_I *savefile ) const {
...
================
*/
void idPhysics_Monster::Restore( idRestore_I *savefile ) {
