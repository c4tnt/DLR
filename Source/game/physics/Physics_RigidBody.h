...
public:	// common physics interface
	...
	void					ApplyImpulse2( const int id, const idVec3 &point, const idVec3 &impulse, const float dstA, const float dstB);
	...
	const idVec3 &			PointVelocity( int id, const idVec3 &pt ) const;
...
private:
	...
	impactEffect_t			CollisionImpulse( const trace_t &collision, idVec3 &impulse );
