...
class idPhysics_Liquid; //For WaterPhysics 1.0 support

typedef enum {
	IMP_REST,			//Stop
	IMP_TOUCH,			//Stop and apply the impulse
	IMP_THROUGTH,		//Move thru obstacle
	IMP_BOUNCE,			//Bounce 
	IMP_RICOCHET,		//Ricochet (Angle-depend bounce) 
	IMP_STUCK			//Stuck into an obstacle
} impactEffect_t;
...
public:	// common physics interface
	...
	virtual const idVec3 &		PointVelocity( int id, const idVec3 &pt ) const = 0;
								// gravity
