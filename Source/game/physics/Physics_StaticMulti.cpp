...
================
*/
void idPhysics_StaticMulti::Save( idSave_I *savefile ) const {
	int i;
...
================
*/
void idPhysics_StaticMulti::Restore( idRestore_I *savefile ) {
	int i, num;
...
================
*/
const idVec3 &idPhysics_StaticMulti::PointVelocity( int id, const idVec3 &pt ) const {
	return vec3_origin;
}
