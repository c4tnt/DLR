...
const float NO_MOVE_TIME					= 2.0f; //Changed from 1.0 for WaterPhysics
...
const float IMPULSE_THRESHOLD				= 1500.0f; //Changed from 500 for WaterPhysics
...
//some constants were Added for WaterPhysics 1.0
...
================
*/
void idAFConstraint::Save( idSave_I *saveFile ) const {
...
================
*/
void idAFConstraint::Restore( idRestore_I *saveFile ) {
	constraintType_t t;
	saveFile->ReadShort( (short &)t );
	assert( t == type );
}
...
================
*/
void idAFConstraint_Fixed::Save( idSave_I *saveFile ) const {
...
================
*/
void idAFConstraint_Fixed::Restore( idRestore_I *saveFile ) {
...
================
*/
void idAFConstraint_BallAndSocketJoint::Save( idSave_I *saveFile ) const {
	idAFConstraint::Save( saveFile );
...
================
*/
void idAFConstraint_BallAndSocketJoint::Restore( idRestore_I *saveFile ) {
	idAFConstraint::Restore( saveFile );
...
================
*/
void idAFConstraint_UniversalJoint::Save( idSave_I *saveFile ) const {
	idAFConstraint::Save( saveFile );
	saveFile->WriteVec3( anchor1 );
	saveFile->WriteVec3( anchor2 );
...
================
*/
void idAFConstraint_UniversalJoint::Restore( idRestore_I *saveFile ) {
	idAFConstraint::Restore( saveFile );
	saveFile->ReadVec3( anchor1 );
	saveFile->ReadVec3( anchor2 );
...
================
*/
void idAFConstraint_Hinge::Save( idSave_I *saveFile ) const {
	idAFConstraint::Save( saveFile );
	saveFile->WriteVec3( anchor1 );
	saveFile->WriteVec3( anchor2 );
	saveFile->WriteVec3( axis1 );
...
================
*/
void idAFConstraint_Hinge::Restore( idRestore_I *saveFile ) {
	bool b;
	idAFConstraint::Restore( saveFile );
	saveFile->ReadVec3( anchor1 );
	saveFile->ReadVec3( anchor2 );
...
================
*/
void idAFConstraint_HingeSteering::Save( idSave_I *saveFile ) const {
...
================
*/
void idAFConstraint_HingeSteering::Restore( idRestore_I *saveFile ) {
...
================
*/
void idAFConstraint_Slider::Save( idSave_I *saveFile ) const {
	idAFConstraint::Save( saveFile );
...
================
*/
void idAFConstraint_Slider::Restore( idRestore_I *saveFile ) {
	idAFConstraint::Restore( saveFile );
...
================
*/
void idAFConstraint_Plane::Save( idSave_I *saveFile ) const {
	idAFConstraint::Save( saveFile );
	saveFile->WriteVec3( anchor1 );
	saveFile->WriteVec3( anchor2 );
...
================
*/
void idAFConstraint_Plane::Restore( idRestore_I *saveFile ) {
	idAFConstraint::Restore( saveFile );
	saveFile->ReadVec3( anchor1 );
	saveFile->ReadVec3( anchor2 );
...
================
*/
void idAFConstraint_Spring::Save( idSave_I *saveFile ) const {
	idAFConstraint::Save( saveFile );
	saveFile->WriteVec3( anchor1 );
	saveFile->WriteVec3( anchor2 );
...
================
*/
void idAFConstraint_Spring::Restore( idRestore_I *saveFile ) {
	idAFConstraint::Restore( saveFile );
	saveFile->ReadVec3( anchor1 );
	saveFile->ReadVec3( anchor2 );
...
================
*/
void idAFConstraint_ConeLimit::Save( idSave_I *saveFile ) const {
	idAFConstraint::Save( saveFile );
...
================
*/
void idAFConstraint_ConeLimit::Restore( idRestore_I *saveFile ) {
	idAFConstraint::Restore( saveFile );
...
================
*/
void idAFConstraint_PyramidLimit::Save( idSave_I *saveFile ) const {
	idAFConstraint::Save( saveFile );
...
================
*/
void idAFConstraint_PyramidLimit::Restore( idRestore_I *saveFile ) {
	idAFConstraint::Restore( saveFile );
...
================
*/
void idAFConstraint_Suspension::SetSuspension( const float up, const float down, const float k, const float d, const float f, const float cl) {
	suspensionUp = up;
	suspensionDown = down;
	suspensionKCompress = k;
	suspensionDamping = d;
	suspensionClamper = cl;
	friction = f;
}
...
void idAFConstraint_Suspension::Evaluate( float invTimeStep ) {
	float suspensionLength, springLength, compression, dampingForce, springForce, clampedFrac;
	...
	start = origin + (suspensionUp + 20.0f) * axis[2];	//Added submerge-awareness area
	end = origin - suspensionDown * axis[2];

//	gameRenderWorld->DebugArrow( idVec4( 1, 0, 0, 0.0f ), origin, end, 15, 0 );
//	gameRenderWorld->DebugArrow( idVec4( 1, 0, 0, 0.0f ), start, origin, 15, 0 );
	...
	clampedFrac = (trace.fraction - (20.0f/(suspensionUp + 20.0f + suspensionDown)));
	if (clampedFrac < 0.0f)
		clampedFrac = 0.0f;

	clampedFrac /= (1.0f - (20.0f/(suspensionUp + 20.0f + suspensionDown)));
...
================
*/
void idAFBody::Save( idSave_I *saveFile ) {
...
================
*/
void idAFBody::Restore( idRestore_I *saveFile ) {
...
void idPhysics_AF::EvaluateBodies( float timeStep ) {
	...
	idAFBody *body;
	idMat3 axis;
	float bMass, invbMass; //Added for WaterPhysics 1.0
...
================
*/
impactEffect_t idPhysics_AF::CollisionImpulse( float timeStep, idAFBody *body, trace_t &collision ) {
...
bool idPhysics_AF::ApplyCollisions( float timeStep ) {
	...
	for ( i = 0; i < collisions.Num(); i++ ) {
		if ( CollisionImpulse( timeStep, collisions[i].body, collisions[i].trace ) == IMP_REST ) {
			return true;
		}
	}
	return false;
...
/*				index = collisions.Num();
				...
				AFCollision_t* collide = &collisions.Alloc();
				collide->body = body;
				collide->trace = collision;
			}
...
//Overwritten for WaterPhysics 1.0
================
*/
...
bool idPhysics_AF::TestIfAtRest( float timeStep ) {
	...
	// WaterPhysics 1.0 ,will be fixed
...
================
*/
void idPhysics_AF_SavePState( idSave_I *saveFile, const AFPState_t &state ) {
	saveFile->WriteBool( ( state.atRest != 0 ) );
...
================
*/
void idPhysics_AF_RestorePState( idRestore_I *saveFile, AFPState_t &state ) {
	bool m;
	saveFile->ReadBool( m );
	state.atRest = m;
...
================
*/
void idPhysics_AF::Save( idSave_I *saveFile ) const {
	int i;
...
================
*/
void idPhysics_AF::Restore( idRestore_I *saveFile ) {
	int i, num;
	bool hasMaster;
