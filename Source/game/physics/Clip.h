...
public:
	...
	static void				SaveTraceModels( idSave_I *savefile );
	static void				RestoreTraceModels( idRestore_I *savefile );
...
public:
	...
	bool					TranslationSingle( trace_t &results, const idVec3 &start, const idVec3 &end, idClipModel *traceFor,
