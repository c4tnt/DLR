...
const char *si_gameTypeArgs[]		= { "singleplayer", "deathmatch", "Tourney", "Team DM", "Last Man", "CTF", "Cooperative", "Campaign", NULL };
...
struct gameVersion_s {
	gameVersion_s( void ) { sprintf( string, "%s 1.0.%d%s%s %s %s %s", GAME_NAME, BUILD_NUMBER, BUILD_DEBUG, ENGINE_VERSION, BUILD_STRING, __DATE__, __TIME__ ); }
	char	string[256];
} gameVersion;
...
idCVar si_maxPlayers(				"si_maxPlayers",			"4",			CVAR_GAME | CVAR_SERVERINFO | CVAR_ARCHIVE | CVAR_INTEGER, "max number of players allowed on the server", 1, 32 );
...
idCVar g_skill(						"g_skill",					"1",			CVAR_GAME, "game skill level" );
idCVar g_nightmare(					"g_nightmare",				"0",			CVAR_GAME | CVAR_ARCHIVE | CVAR_BOOL, "if nightmare mode is allowed" );
idCVar g_gravity(					"g_gravity",		DEFAULT_GRAVITY_STRING, CVAR_GAME | CVAR_FLOAT, "gravity, default is 1066" );
...
idCVar g_runaway(					"g_runaway",				"5000000",		CVAR_GAME | CVAR_INTEGER, "script runaway time", 1000, 0xFFFFFF );
idCVar g_unrolldisasm(				"g_unroll",					"800",			CVAR_GAME | CVAR_INTEGER, "disasm length when script runaway failed", 0, 5000000 );
...
idCVar g_debugAxis(					"g_debugAxis",				"0",			CVAR_GAME | CVAR_BOOL, "draw debug axis" );
idCVar g_debugCursor(				"g_debugCursor",			"0",			CVAR_GAME | CVAR_BOOL, "displays player cursor's hit" );
...
idCVar ai_debugTracking(			"ai_debugTracking",			"0",			CVAR_GAME | CVAR_BOOL, "draws enemy positions" );
...
idCVar ai_showHealth(				"ai_showHealth",			"0",			CVAR_GAME | CVAR_BOOL, "Draws the AI's health above its head" ); // ROE
...
idCVar g_editEntityMode(			"g_editEntityMode",			"0",			CVAR_GAME | CVAR_INTEGER,	"0 = off\n"
																											...
																											"6 = entity names\n"
																											"7 = entity models"
																											"8 = vertex color", 0, 8, idCmdSystem::ArgCompletion_Integer<0,8> );

idCVar g_testHighlight(				"g_testHighlight",			"0",			CVAR_GAME | CVAR_INTEGER,	"0 = off\n"
																											"1 = ambient\n"
																											"2 = shadeless point\n"
...
idCVar g_vehicleSuspensionClamper  ("g_vehicleSuspensionLowclamp","0",			CVAR_GAME | CVAR_FLOAT, "" );
...
idCVar pm_flightspeed(				"pm_flightspeed",			"140",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "speed the player can move while flying" );
...
idCVar g_testGlobalMaterial(		"g_testGlobalMaterial",		"",				CVAR_GAME, "name of global material" );
