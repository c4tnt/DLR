...
class idTarget_Skill : public idTarget {
public:
	CLASS_PROTOTYPE( idTarget_Skill );
...
private:
	void				Event_Activate( idEntity *activator );
	void				Event_RestoreInfluence( void );
	void				Event_GatherEntities( void );
