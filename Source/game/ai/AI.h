...
extern const idEventDef AI_LaunchProjectileVec;
...
public:
	...
	void					HSave( idSave_I *savefile );
	void					HRestore( idRestore_I *savefile );
...
protected:
	...
	float					infightchance;		// infight chance
	...
	idProjectile			*ReplyProjectile( const idVec3 &pos, const idVec3 &dir );
	idProjectile			*CreateProjectileWDef( const idDict &pDef, const idVec3 &pos, const idVec3 &dir );
	...
	void					Event_FindEnemy( idEventReturn *returnContext, int useFOV ); //return e
	void					Event_FindEnemyAI( idEventReturn *returnContext, int useFOV ); //return e
	void					Event_FindEnemyInCombatNodes( idEventReturn *returnContext ); //return e
	void					Event_ClosestReachableEnemyOfEntity( idEventReturn *returnContext, idEntity *team_mate ); //return e
	void					Event_HeardSound( idEventReturn *returnContext, int ignore_team ); //return e
	void					Event_SetEnemy( idEntity *ent );
	void					Event_ClearEnemy( void );
	void					Event_MuzzleFlash( const char *jointname ); 
	void					Event_CustomMissile( idEventReturn *returnContext, const char *entityDefName, const char *jointname, int UseSpawnArgs );
	void					Event_CreateMissile( idEventReturn *returnContext, const char *jointname ); //return e
	void					Event_AttackMissile( idEventReturn *returnContext, const char *jointname ); //return e
	void					Event_FireMissileAtTarget( idEventReturn *returnContext, const char *jointname, const char *targetname ); //return e
	void					Event_LaunchMissile( idEventReturn *returnContext, const idVec3 &muzzle, const idAngles &ang ); //return e
	void					Event_LaunchProjectile( const char *entityDefName, const char *jointname );	// May be uncompatible with ROE
	void					Event_AttackMelee( idEventReturn *returnContext, const char *meleeDefName ); //return d
	...
	void					Event_MeleeAttackToJoint( idEventReturn *returnContext, const char *jointname, const char *meleeDefName ); //return d
	void					Event_RandomPath( idEventReturn *returnContext ); //return e
	void					Event_CanBecomeSolid( idEventReturn *returnContext ); //return f
	void					Event_BecomeSolid( void ); 
	void					Event_BecomeNonSolid( void );
	void					Event_BecomeRagdoll( idEventReturn *returnContext ); //return d
	void					Event_StopRagdoll( void );
	void					Event_SetHealth( float newHealth );
	void					Event_GetHealth( idEventReturn *returnContext ); //return f
	void					Event_AllowDamage( void );
	void					Event_IgnoreDamage( void );
	void					Event_GetCurrentYaw( idEventReturn *returnContext ); //return f
	void					Event_TurnTo( float angle );
	void					Event_TurnToPos( const idVec3 &pos );
	void					Event_TurnToEntity( idEntity *ent );
	void					Event_MoveStatus( idEventReturn *returnContext ); //return d
	...
	void					Event_FacingIdeal( idEventReturn *returnContext ); //return d
	void					Event_FaceEnemy( void );
	void					Event_FaceEntity( idEntity *ent );
	void					Event_WaitAction( idEventReturn *returnContext, const char *waitForState ); //tracing
	void					Event_GetCombatNode( idEventReturn *returnContext ); //return e
	void					Event_EnemyInCombatCone( idEventReturn *returnContext, idEntity *ent, int use_current_enemy_location ); //return e
	void					Event_WaitMove( idEventReturn *returnContext );
	void					Event_GetJumpVelocity( idEventReturn *returnContext, const idVec3 &pos, float speed, float max_height ); //return v
	void					Event_EntityInAttackCone( idEventReturn *returnContext, idEntity *ent ); //return d
	void					Event_CanSeeEntity( idEventReturn *returnContext, idEntity *ent ); //return d
	void					Event_SetTalkTarget( idEntity *target );
	void					Event_GetTalkTarget( idEventReturn *returnContext ); //return e
	void					Event_SetTalkState( int state );
	void					Event_EnemyRange( idEventReturn *returnContext ); //return f
	void					Event_EnemyRange2D( idEventReturn *returnContext ); //return f
	void					Event_GetEnemy( idEventReturn *returnContext ); //return e 
	void					Event_GetEnemyPos( idEventReturn *returnContext ); //return v
	void					Event_GetEnemyEyePos( idEventReturn *returnContext ); //return v
	void					Event_PredictEnemyPos( idEventReturn *returnContext, float time ); //return v
	void					Event_CanHitEnemy( idEventReturn *returnContext ); //return d
	void					Event_CanHitEnemyFromAnim( idEventReturn *returnContext, const char *animname ); //return d
	void					Event_CanHitEnemyFromJoint( idEventReturn *returnContext, const char *jointname ); //return d
	void					Event_EnemyPositionValid( idEventReturn *returnContext ); //return d
	void					Event_ChargeAttack( const char *damageDef );
	void					Event_TestChargeAttack( idEventReturn *returnContext ); //return f
	void					Event_TestAnimMoveTowardEnemy( idEventReturn *returnContext, const char *animname ); //return d
	void					Event_TestAnimMove( idEventReturn *returnContext, const char *animname ); //return d
	void					Event_TestMoveToPosition( idEventReturn *returnContext, const idVec3 &position ); //return d
	void					Event_TestMeleeAttack( idEventReturn *returnContext ); //return d
	void					Event_TestAnimAttack( idEventReturn *returnContext, const char *animname ); //return d
	void					Event_Shrivel( idEventReturn *returnContext, float shirvel_time ); //tracing
	void					Event_Burn( void );
	void					Event_PreBurn( void );
	void					Event_ClearBurn( void );
	void					Event_SetSmokeVisibility( int num, int on );
	void					Event_NumSmokeEmitters( idEventReturn *returnContext ); //return d
	void					Event_StopThinking( void );
	void					Event_GetTurnDelta( idEventReturn *returnContext ); //return f
	void					Event_GetMoveType( idEventReturn *returnContext ); //return d
	...
	void					Event_GetClosestHiddenTarget( idEventReturn *returnContext, const char *type ); //return e
	void					Event_GetRandomTarget( idEventReturn *returnContext, const char *type ); //return e
	void					Event_TravelDistanceToPoint( idEventReturn *returnContext, const idVec3 &pos ); //return f
	void					Event_TravelDistanceToEntity( idEventReturn *returnContext, idEntity *ent ); //return f
	void					Event_TravelDistanceBetweenPoints( idEventReturn *returnContext, const idVec3 &source, const idVec3 &dest ); //return f
	void					Event_TravelDistanceBetweenEntities( idEventReturn *returnContext, idEntity *source, idEntity *dest ); //return f
	...
	void					Event_GetAngles( idEventReturn *returnContext ); //return v
	...
	void					Event_GetObstacle( idEventReturn *returnContext ); //return e
	void					Event_PushPointIntoAAS( idEventReturn *returnContext, const idVec3 &pos ); //return v
	void					Event_GetTurnRate( idEventReturn *returnContext ); //return f
	...
	void					Event_FindActorsInBounds( idEventReturn *returnContext, const idVec3 &mins, const idVec3 &maxs ); //return e
	void 					Event_CanReachPosition( idEventReturn *returnContext, const idVec3 &pos ); //return d
	void 					Event_CanReachEntity( idEventReturn *returnContext, idEntity *ent ); //return d
	void					Event_CanReachEnemy( idEventReturn *returnContext ); //return d
	void					Event_GetReachableEntityPosition( idEventReturn *returnContext, idEntity *ent ); //return v
...
// ROE
	...
	void					Event_StartEmitter( idEventReturn *returnContext, const char* name, const char* joint, const char* particle );
	void					Event_GetEmitter( idEventReturn *returnContext, const char* name );
...
public:
	...
	void				HSave( idSave_I *savefile ) const;
	void				HRestore( idRestore_I *savefile );

	void				Spawn( void );
	bool				IsDisabled( void ) const;
	bool				EntityInView( idEntity *actor, const idVec3 &pos );
