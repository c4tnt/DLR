...
private:
	void	Event_ChooseObjectToThrow( idEventReturn *returnContext, const idVec3 &mins, const idVec3 &maxs, float speed, float minDist, float offset );
...
================
*/
void idAI_Vagary::Event_ChooseObjectToThrow( idEventReturn *returnContext, const idVec3 &mins, const idVec3 &maxs, float speed, float minDist, float offset ) {
	idEntity *	ent;
