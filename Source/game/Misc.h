...
private:
	...
	void					Event_GetAnimationLength( idEventReturn *returnContext );
};
...
===============================================================================
*/
extern const idEventDef EV_Shoot;
extern const idEventDef EV_Reload;

class idProjectile;

typedef enum ShooterState_s {
	SHS_READY,
	SHS_SPINUP,
	SHS_SHOOT,
	SHS_RELOAD,
...
class idFuncShooter : public idEntity {
public:
	...
	void				AimToEntity( idEntity* ent );
	int					Shoot( int ProjNum );

	void				Event_Enable( void );
	void				Event_Disable( void );
	void				Event_Shoottime( void );
	void				Event_MatchTarget( void );
	void				Event_Activate( idEntity *activator );
	void				Event_Reload( void );
	void				Event_Aim( idEntity* to );
...
private:
	...
	idVec3				aimDir;		//Direction for aiming
	idEntityPtr<idEntity> aimEnt;	//Entity for aiming
	idEntityPtr<idEntity> activatorPtr;	//Entity that triggers this
	float				push;		//Physics push speed
	ShooterState_t		state;		//Enabled
	int					proj_loaded;
