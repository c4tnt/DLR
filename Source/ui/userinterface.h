...
#if API_VERS >= 3				//c4tnt: hmm... We can simulate this?
...
#else
	//c4tnt: recovered CursorX\CursorY access.
	//CursorX = this[0C4h]
	//CursorY = this[0C0h]
private:
	char  _someclassdata[188];
	float _curX;
	float _curY;

public:
	float						CursorX() { return _curX; };
	float						CursorY() { return _curY; };
